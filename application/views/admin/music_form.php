    ...
    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12  no-padding">
      ...
      <div class="rows">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding">
          ...
          <div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
              <label for="cover_lagu" class="btn btn-warning mar-top-2"><span class="glyphicon glyphicon-picture"></span> &nbsp; Cover Lagu</label>
              <input type="file" name="cover" id="cover_lagu" class="hide">
          </div>
        </div>
      </div>
      <div class="rows">
